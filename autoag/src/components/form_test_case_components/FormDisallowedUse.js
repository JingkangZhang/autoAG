    ...
    return (
      <Modal isOpen={this.props.modal} toggle={this.props.toggle}>
        ...
        <ModalBody>
          ...
          <p>This amazing python module wrote by CS61A staff checks for certain usage patterns in a python file.</p>
          <p>To include these checks, put the names on the left column in quotes and separate them with commas.</p>
          <p>e.g., 'Add', 'Pow'</p>
